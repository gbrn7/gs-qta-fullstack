          ...
          <tr>
            ...
            <td class="">
              <div class="btn-wrapper d-flex gap-2 flex-wrap">
                <a href="#" data-id="{{$branch->id}}" data-bs-toggle="tooltip" data-bs-custom-class="custom-tooltip"
                  data-bs-title="Perbarui cabang" data-nama="{{$branch->nama}}" data-alamat="{{$branch->alamat}}"
                ...
                <a href="#" class="delete btn btn-action btn-danger text-white" data-bs-toggle="tooltip"
                  data-bs-custom-class="custom-tooltip" data-bs-title="Hapus cabang" data-nama="{{$branch->nama}}"
                  data-id="{{$branch->id}}">
